...
import Other.Algebra.Homology.HomComplexPostcompNaturality
...
local instance checkPlainHasDerivedCategory :
    HasDerivedCategory (AnalyticAdditiveSheaf X) :=
  HasDerivedCategory.standard _

lemma test_constantIntegerSheafComplexIntIsoSingle_inv_quasiIso :
...
lemma test_toSmallShiftedHom_postcompClass
...
set_option backward.isDefEq.respectTransparency false in
set_option backward.isDefEq.respectTransparency.types false in
lemma test_precompEquiv_hypercohomologyMap
    ...
    Localization.SmallShiftedHom.precompEquiv
        ...
        (test_constantIntegerSheafComplexIntIsoSingle_inv_quasiIso X)
        (hypercohomologyMap X f n a) =
      (Localization.SmallShiftedHom.precompEquiv
          (constantIntegerSheafComplexIntIsoSingle X).inv
          (test_constantIntegerSheafComplexIntIsoSingle_inv_quasiIso X) a).comp
        (Localization.SmallShiftedHom.mk₀
          (analyticQuasiIsomorphisms X) 0 rfl f)
        (zero_add n) := by
...
def testPlainHypercohomologyGlobalSectionsKInjective
...
set_option backward.isDefEq.respectTransparency false in
set_option backward.isDefEq.respectTransparency.types false in
lemma testPlainHypercohomologyGlobalSectionsKInjective_naturality
    (K L : CochainComplex (AnalyticAdditiveSheaf X) ℤ)
    [K.IsKInjective] [L.IsKInjective] (f : K ⟶ L) (n : ℤ)
    (a : Hypercohomology X K n) :
    testPlainHypercohomologyGlobalSectionsKInjective X L n
        (hypercohomologyMap X f n a) =
      HomologicalComplex.homologyMap
        (((TopCat.Sheaf.IsFlasque.BoundedBelowComplex.globalSectionsFunctor
          (TopCat.of (ComplexPoint X))).mapHomologicalComplex (.up ℤ)).map f) n
        (testPlainHypercohomologyGlobalSectionsKInjective X K n a) := by
  ...
  have hx :
    ...
    rw [test_toSmallShiftedHom_postcompClass X]
    rw [hx_toSmallShiftedHom]
    exact test_precompEquiv_hypercohomologyMap X f n a
  ...
  dsimp only [testPlainHypercohomologyGlobalSectionsKInjective]
  rw [hx, hy]
  exact hΓy
...
set_option backward.isDefEq.respectTransparency false in
set_option backward.isDefEq.respectTransparency.types false in
lemma testPlainHypercohomologyEquivGlobalSectionsOfResolution_map
    ...
    HomologicalComplex.homologyMap
      ...
      (hypercohomologyEquivGlobalSectionsOfResolution X K I i n a) =
        testPlainHypercohomologyGlobalSectionsKInjective X I n
  ...
  dsimp only [hypercohomologyEquivGlobalSectionsOfResolution,
    testPlainHypercohomologyGlobalSectionsKInjective, Equiv.trans_apply]
  change b ((inv b) _) = _
...
set_option backward.isDefEq.respectTransparency false in
set_option backward.isDefEq.respectTransparency.types false in
lemma testPlainHypercohomologyEquivGlobalSectionsOfResolution_naturality_to_kInjective
  ...
  rw [ha, testPlainHypercohomologyGlobalSectionsKInjective_naturality,
    ← testPlainHypercohomologyEquivGlobalSectionsOfResolution_map]
...
set_option backward.isDefEq.respectTransparency false in
set_option backward.isDefEq.respectTransparency.types false in
lemma testPlainHypercohomologyEquivGlobalSections_naturality_to_kInjective
  ...
  exact
    testPlainHypercohomologyEquivGlobalSectionsOfResolution_naturality_to_kInjective
      X K I L i f n a

set_option backward.defeqAttrib.useBackward true in
set_option backward.isDefEq.respectTransparency false in
set_option backward.isDefEq.respectTransparency.types false in
lemma testPlainHypercohomologyEquivGlobalSections_naturality
    (K L : CochainComplex (AnalyticAdditiveSheaf X) ℤ)
  ...
  change b _ = b _
  rw [testPlainHypercohomologyEquivGlobalSectionsOfResolution_map X L I i]
  change testPlainHypercohomologyGlobalSectionsKInjective X I n
      (hypercohomologyMap X i n (hypercohomologyMap X f n a)) = _
  rw [← hypercohomologyMap_comp_apply]
  rw [testPlainHypercohomologyEquivGlobalSections_naturality_to_kInjective
...
set_option backward.isDefEq.respectTransparency false in
set_option backward.isDefEq.respectTransparency.types false in
lemma test_rationalToComplexSingularCochainHypercohomologyEquivGlobalSections_naturality
  ...
  let SQ := singularCochainSheafComplexInt X ℚ
  let SC := singularCochainSheafComplexInt X ℂ
  ...
  exact testPlainHypercohomologyEquivGlobalSections_naturality X
