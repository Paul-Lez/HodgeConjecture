...
run_cmd do
  ...
  let modules := otherModules.map ("HodgeConjecture.Other." ++ ·) ++
    ["HodgeConjecture.Other.Algebra.Homology.DerivedCategory.RightDerivedFunctorPlusShift",
     "HodgeConjecture.Other.Algebra.Homology.DerivedCategory.RightDerivedFunctorPlusNaturality",
     "HodgeConjecture.Other.Algebra.Homology.DerivedCategory.RightDerivedFunctorPlusShiftNaturality",
     "HodgeConjecture.Other.Algebra.Homology.MapExtend",
     "HodgeConjecture.Other.Algebra.Homology.MapExtendNaturality",
     "HodgeConjecture.Other.Algebra.Homology.HomComplexPostcompNaturality",
     "HodgeConjecture.Other.CategoryTheory.Abelian.KernelCompositionShortExact",
     "HodgeConjecture.Other.Algebra.Homology.DerivedCategory.MappingCoconeShortExact",
     "HodgeConjecture.Other.Algebra.Homology.DerivedCategory.MappingConeConnectingNaturality",
     "HodgeConjecture.Other.Algebra.Homology.DerivedCategory.RightDerivedFunctorPlusInjectiveModel",
     "HodgeConjecture.Other.Algebra.Homology.DerivedCategory.ShortExactQuasiIso",
     "HodgeConjecture.Other.Algebra.Homology.HomComplexShiftNaturality",
     ...
     "HodgeConjecture.Other.Algebra.Homology.DerivedCategory.MappingCoconeShortExactNaturality",
     "HodgeConjecture.Other.Algebra.Homology.DerivedCategory.MappingConeMapNaturality",
     ...
     "HodgeConjecture.Other.Algebra.Homology.MapHomologyShift",
     ...
     "HodgeConjecture.Other.Algebra.Homology.MapArrowConeConnecting",
