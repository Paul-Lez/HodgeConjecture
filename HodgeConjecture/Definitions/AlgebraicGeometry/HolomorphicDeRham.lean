...
import HodgeConjecture.Lemmas.AlgebraicTopology.SingularCochainSheaf
...
private lemma holomorphicDeRhamComplex_exactAt_succ
  ...
  have hP : (P.sc' p (p + 1) ((p + 1) + 1)).map stalk |>.Exact :=
    AlgebraicTopology.Singular.stalkExact_of_locallyPrimitive
      (TopCat.of (ComplexPoint X)) (P.sc' p (p + 1) ((p + 1) + 1)) (by
