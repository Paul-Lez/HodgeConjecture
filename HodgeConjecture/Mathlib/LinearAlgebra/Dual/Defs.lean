...
/-- The dual of a split injection is surjective: extend a functional by precomposing with the
retraction. Over a field use `LinearMap.dualMap_surjective_of_injective`, which needs no
splitting. -/
