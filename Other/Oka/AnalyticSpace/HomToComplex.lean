...
public import Other.Oka.AnalyticSpace.Noetherian
public import Other.Oka.RingTheory.Filtration
...
`ComplexAnalytic.AnalyticSpace.eval_c_app`, in `Other/Oka/AnalyticSpace/Evaluation.lean`. This file
...
`Other/Oka/AnalyticSpace/HolomorphicMap.lean`, which produces a morphism from a section, this gives
...
`Other/Oka/AnalyticSpace/HolomorphicMapGeneral.lean` covers `Z = ℂ^n` along with every other `Z`, and
...
The closed immersion of `Other/Oka/AnalyticSpace/LocalModel.lean` lands in the `restrict ⊤`
