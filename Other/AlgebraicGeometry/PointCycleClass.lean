...
@[simp] lemma pointCycleClassOnCycles_single
    ...
    pointCycleClassOnCycles V d (CodimensionCycle.single x hx n) =
...
lemma pointCycleClassOnCycles_single_closedPoint
    ...
    pointCycleClassOnCycles V d (CodimensionCycle.single x hcodim n) =
...
lemma pointCycleClassOnCycles_sum_single
    ...
    pointCycleClassOnCycles V d (∑ i ∈ s, CodimensionCycle.single (x i) (hx i) (n i)) =
...
def pointCycleClassRationalExtensionBilinear :
    ℚ →ₗ[ℚ] CodimensionCycle V.scheme d →ₗ[ℤ]
...
represented by `ℚ ⊗[ℤ] CodimensionCycle V.scheme d`. No rational-equivalence
quotient is taken here. -/
def rationalPointCycleClassOnCycles :
    TensorProduct ℤ ℚ (CodimensionCycle V.scheme d) →ₗ[ℚ]
      H^(2 * (d : ℤ))(V.over; ℚ) :=
...
@[simp] lemma rationalPointCycleClassOnCycles_tmul
    (q : ℚ) (c : CodimensionCycle V.scheme d) :
...
@[simp] lemma rationalPointCycleClassOnCycles_tmul_single
    ...
    rationalPointCycleClassOnCycles V d (q ⊗ₜ[ℤ] CodimensionCycle.single x hx 1) =
