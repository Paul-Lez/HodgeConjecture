...
The codimension-zero comparison span is the line generated by the degree-zero rational
cohomology unit.  On a connected analytification, the computation of
...
def codimensionZeroCycleClassSpan : Submodule ℚ (H^0(X; ℚ)) :=
  Submodule.span ℚ {rationalCohomologyUnit X}

/-- The codimension-zero comparison span is the unit line. -/
lemma codimensionZeroCycleClassSpan_eq_span_unit :
    codimensionZeroCycleClassSpan X = Submodule.span ℚ {rationalCohomologyUnit X} :=
  rfl
