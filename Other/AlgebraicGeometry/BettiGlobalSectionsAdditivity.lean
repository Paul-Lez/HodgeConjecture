...
/-!
# The Betti global-sections comparison as a `ℚ`-linear equivalence

The Betti comparison is built as an additive equivalence in
`Definitions/AlgebraicGeometry/BettiGlobalSectionsComparison.lean`. Because both sides are
