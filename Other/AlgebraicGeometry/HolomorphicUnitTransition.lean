...
local instance holomorphicUnitTransitionTopology : TopologicalSpace (ComplexPoint X s) :=
  Point.analyticTopology

variable (E : HolomorphicUnitExtension s d)

/-- The nowhere-zero holomorphic transition function on a common open subset. -/
def transitionUnit (x y : ComplexPoint X s) (V : Opens (TopCat.of (ComplexPoint X s)))
...
@[simp]
theorem transitionUnit_self (x : ComplexPoint X s)
    (V : Opens (TopCat.of (ComplexPoint X s))) (hx : V ≤ E.localLifts.opens x) :
...
theorem transitionUnit_mul (x y z : ComplexPoint X s)
    (V : Opens (TopCat.of (ComplexPoint X s)))
    (hx : V ≤ E.localLifts.opens x) (hy : V ≤ E.localLifts.opens y)
...
theorem transitionUnit_restrict_apply (x y : ComplexPoint X s)
    {U V : Opens (TopCat.of (ComplexPoint X s))}
...
theorem transitionUnit_ne_zero (x y : ComplexPoint X s)
    (V : Opens (TopCat.of (ComplexPoint X s)))
