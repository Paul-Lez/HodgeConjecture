...
public import Other.AlgebraicGeometry.SheafBorelMoorePointForget

/-!
# A derived augmentation from a whole-space chain comparison

An augmentation of the termwise whole-space singular-chain sheaf complex gives an
augmentation of the actual derived Borel--Moore object whenever the canonical
termwise-to-derived map is invertible.  The construction retains the normalization
of the literal point simplex.
-/
